...
public class NotifySubscribersVehicleValuesChangedModelCommand extends ModelCommand implements Observable {

    private VehicleBuffer sender;
    private Event event;

    public NotifySubscribersVehicleValuesChangedModelCommand(VehicleBuffer vehicleBuffer, Event event) {
        super();
