...
public class ModelCommandSetRaceManagerState extends ModelCommand {

    private RaceManager raceManager;
    private State raceManagerState;

    public ModelCommandSetRaceManagerState(RaceManager raceManager, State raceManagerState) {
        super();
